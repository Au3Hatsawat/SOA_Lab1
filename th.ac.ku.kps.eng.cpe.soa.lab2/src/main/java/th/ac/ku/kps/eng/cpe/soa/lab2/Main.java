...
public class Main {
	...
	customer.getPhoneNumber().add(new PhoneNumber("12345"));
	customer.getPhoneNumber().add(new PhoneNumber("222"));
	JAXBContext jc = JAXBContext.newInstance(Customer.class);
	Marshaller m = jc.createMarshaller();
	m.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, Boolean.TRUE);
	m.setProperty(Marshaller.JAXB_ENCODING, "UTF-8");
	m.setProperty(Marshaller.JAXB_SCHEMA_LOCATION,"http://localhost:8080/xml/customer.xsd");
